...
# TWRP/Android Configs: Logcat
TARGET_USES_LOGD := true
TWRP_INCLUDE_LOGCAT := true

# SHRP Configs
SHRP_PATH := device/samsung/m30sdd
SHRP_MAINTAINER := yukosky
SHRP_DEVICE_CODE := m30sdd
SHRP_REC_TYPE := SAR
SHRP_DEVICE_TYPE := Aonly
